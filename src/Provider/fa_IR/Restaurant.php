...
class Restaurant extends Base
{
    protected static $foodNames = [
        'پیتزا', 'همبرگر', 'چیز برگر', 'برگر گوشت خوک نمک سود (Bacon Burger)', 'برگر گوشت خوک نمک سود با پنیر (Bacon Cheeseburger)',
        'همبرگر کوچک', 'همبرگر کوچک با پنیر', 'برگر گوشت خوک کوچک (Little Bacon Burger)', 'برگر گوشت خوک کوچک با پنیر (Little Bacon Cheeseburger)',
        'ساندویچ سبزیجات', 'ساندویچ سبزیجات با پنیر', 'پنیر کبابی',
        'هات داگ پنیری', 'هات داگ با گوشت خوک (Bacon Dog)', 'هات داگ پنیری با گوشت گوساله (Bacon Cheese Dog)', 'ماکارونی'
    ];
